...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test":
        ...
        elif config.TRAIN.DATA.DATASET == "VTTriCam":
            train_loader = data_loader.VTTriCamLoader.VTTriCamLoader
        ...
        elif config.VALID.DATA.DATASET == "VTTriCam":
            valid_loader = data_loader.VTTriCamLoader.VTTriCamLoader
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.TEST.DATA.DATASET == "VTTriCam":
            test_loader = data_loader.VTTriCamLoader.VTTriCamLoader
        ...
        elif config.UNSUPERVISED.DATA.DATASET == "VTTriCam":
            unsupervised_loader = data_loader.VTTriCamLoader.VTTriCamLoader
